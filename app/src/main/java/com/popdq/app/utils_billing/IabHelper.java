...
package com.popdq.app.utils_billing;
...
public class IabHelper {
    ...
    public void consumbyToken(String token) throws RemoteException {
        mService.consumePurchase(3, mContext.getPackageName(), token);
    }

    public Bundle getListPurchaed() throws RemoteException {
        return mService.getPurchases(3, mContext.getPackageName(), "inapp", null);
    }
