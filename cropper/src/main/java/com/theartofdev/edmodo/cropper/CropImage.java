...
public final class CropImage {
     ...
     * @param context used to access Android APIs, like content resolve, it is your activity/fragment/widget.
     */
    public static Uri getCaptureImageOutputUri(@NonNull Context context, String name) {
     ...
     */
    public static Uri getPickImageResultUri(@NonNull Context context, @Nullable Intent data, String name) {
        boolean isCamera = true;
        if (data != null && data.getData() != null) {
            String action = data.getAction();
            isCamera = action != null && action.equals(MediaStore.ACTION_IMAGE_CAPTURE);
        }
        return isCamera || data.getData() == null ? getCaptureImageOutputUri(context, name) : data.getData();
    }
